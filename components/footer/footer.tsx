    ...
    >
      ...
      >
        <div className={styles.brandSocialGroup}>
          <Reveal className={styles.brandReveal} revealId="footer-brand">
        ...
        <Reveal className={styles.legalReveal} revealId="footer-legal">
        ...
        <Reveal className={styles.contactReveal} revealId="footer-contact">

    ...
    >
      ...
      >
        <Reveal
          ...
          start="top 78%"
          triggerClosest="[data-project-site-showcase-section]"
          y={0}
        >
          <Image
            alt={image.alt}
        ...
        >
          <div
            aria-hidden="true"
            className="absolute inset-0 z-0 hidden after:absolute after:right-0 after:top-0 after:h-[54.667%] after:w-[1.389%] after:bg-[#343434] md:block"
            data-project-site-showcase-steps
          >
            <ArchitecturalStairs
              className="[&>[data-stair-index='1']]:left-0 [&>[data-stair-index='1']]:top-0 [&>[data-stair-index='1']]:h-[6.778%] [&>[data-stair-index='1']]:w-[27.708%] [&>[data-stair-index='2']]:left-[27.708%] [&>[data-stair-index='2']]:top-0 [&>[data-stair-index='2']]:h-[20.333%] [&>[data-stair-index='2']]:w-[6.458%] [&>[data-stair-index='3']]:left-[34.167%] [&>[data-stair-index='3']]:top-0 [&>[data-stair-index='3']]:h-[24%] [&>[data-stair-index='3']]:w-[45.486%] [&>[data-stair-index='4']]:left-[79.653%] [&>[data-stair-index='4']]:top-0 [&>[data-stair-index='4']]:h-[30.222%] [&>[data-stair-index='4']]:w-[18.958%]"
          ...
          >
            ...
            <span
              aria-hidden="true"
              className="block size-[1.25rem] shrink-0 bg-[url('/assets/blocks/orange-block.svg')] bg-cover bg-center"
          ...
          <div
            className="absolute left-[1.5rem] right-[1.5rem] top-[5.25rem] z-20 md:left-auto md:right-0 md:top-0 md:w-[29.583%]"
